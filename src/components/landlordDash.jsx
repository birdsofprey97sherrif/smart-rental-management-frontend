...
function LandlordDashboard({
    ...
    return (
        <div className="p-6 space-y-6">
            ...
            {/* Stats Overview */}
            {(() => {
                const { houses = {}, tenants = 0, caretakers = 0, defaulters = 0 } = stats;
                return (
                    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        <div className="bg-white p-4 rounded shadow">
                            <h2 className="text-lg font-semibold">Houses</h2>
                            <p>Total: {houses.total ?? 0}</p>
                            <p>Occupied: {houses.occupied ?? 0}</p>
                            <p>Vacant: {houses.vacant ?? 0}</p>
                        </div>
                        ...
                        <div className="bg-white p-4 rounded shadow">
                            ...
                            <button
                                ...
                                className={`mt-2 px-3 py-1 rounded text-sm text-white ${bulkSending || defaulters.length === 0
